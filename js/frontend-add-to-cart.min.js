  ...
  (t.prototype.onAddToCart = function (t) {
    ...
    if (a.is(".ajax_add_to_cart")) {
      ...
      e.each(a.data(), function (t, a) {
        ...
        e(document.body).trigger("adding_to_cart", [a, r]),
        e.post(
    ...
    (t.prototype.updateButton = function (t, a, r, o) {
      (o = void 0 !== o && o) &&
        ...
        e(document.body).trigger("wc_cart_button_updated", [o]));
    }),
    (t.prototype.updateCartPage = function () {
      ...
      e.get(t, function (t) {
        e(".shop_table.cart:eq(0)").replaceWith(
          e(t).find(".shop_table.cart:eq(0)")
        ),
          e(".cart_totals:eq(0)").replaceWith(e(t).find(".cart_totals:eq(0)")),
          e(".cart_totals, .shop_table.cart")
            .stop(!0)
            .css("opacity", "1")
            .unblock(),
