(function ($) {
  ...
  function rbtLazyLoad() {
    ...
    $(imagePlaceholder)
      .on("load", function () {
        var load = function () {
          $(".rbt-list .rbt-lazy-load img:not(.rbt-lazy-loading)").each(
            function (i, object) {
              object = $(object);
      ...
      .attr(
        "src",
        "https://toolbar.qodeinteractive.com/_toolbar/assets/img/rbt-placeholder.jpg"
      );
  }
  ...
  function rbtListToggle() {
    var opener = $(".rbt-theme-dropdown .rbt-btn"),
      list = $(".rbt-sidearea"),
      splitScreenPresent =
        typeof $.fn.multiscroll !== "undefined" &&
        typeof $.fn.multiscroll.setMouseWheelScrolling !== "undefined";
    fullPagePresent =
      typeof $.fn.fullpage !== "undefined" &&
      typeof $.fn.fullpage.setMouseWheelScrolling !== "undefined";
  ...
  function rbtSmoothScrollCompatibility() {
    var smoothScrollEnabled =
      $('body[class*="smooth-scroll"]').length ||
      $('body[class*="smooth_scroll"]').length;
